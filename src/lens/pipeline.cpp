...
void createLensPipeline()
{
    ...
    // No vertex input - we generate fullscreen triangle in shader
    ...
    // Push constants for distortion params
    ...
    layoutInfo.pSetLayouts = &lensDescriptorSetLayout;
    layoutInfo.pushConstantRangeCount = 1;
    layoutInfo.pPushConstantRanges = &pushConstant;

    vkCreatePipelineLayout(device, &layoutInfo, nullptr, &lensPipelineLayout);
