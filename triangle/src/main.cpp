...
private:
    ...
    struct Vertex
    {
        ...
        static std::array<VkVertexInputAttributeDescription, 2UL> getAttributeDescriptions()
        {
            std::array<VkVertexInputAttributeDescription, 2UL> attributeDescriptions{};
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        ...
        {
            throw std::runtime_error("failed to begin recordign command buffer!");
        }
    ...
    void createCommandPool()
    {
        ...
        {
            throw std::runtime_error("failedto create command pool!");
        }
    }
    ...
    void createRenderPass()
    {
        ...
        {
            throw std::runtime_error("failedto create render pass!");
        }
    }
